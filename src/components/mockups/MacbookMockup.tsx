// Adapted from https://cuicui.day/other/mock-ups (Macbook mock-up, inspired by Devices CSS)
...
export function MacbookMockup({
  ...
  return (
    <div className={`relative z-1 mx-0 my-4 max-h-[434px] w-[740px] ${className ?? ""}`}>
